...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        default=None,
        help=(
            "Thư mục xuất COCO 7-class sau khi import. "
            "Nếu không truyền, dùng data/interim/external/roboflow_coco_7class."
        ),
    )
    ...
    parser.add_argument(
        ...
        default=None,
        help=(
            "Thư mục chứa ảnh đã copy từ Roboflow. "
            "Nếu không truyền, dùng data/interim/external/roboflow_images."
        ),
    )
